...
class HuaweiBookmarkInfoWindowAdapter private constructor(private val binding: BookmarkLayoutBinding)
    : HuaweiMap.InfoWindowAdapter
{

    companion object {
        fun from(inflater: LayoutInflater): HuaweiBookmarkInfoWindowAdapter {
            ...
            return HuaweiBookmarkInfoWindowAdapter(binding)
        }
    }
